...
```
❯ go run mage.go build
Logs:    _build/logs/latest (_build/logs/20200723041555)
Version: v0.1.0-17-g29f9b23-dirty
Build:   _build/magnet/github.com/gravitational/magnet/examples/golang
...
```
❯ go run mage.go buildInContainer
Logs:    _build/logs/latest (_build/logs/20200723042056)
Version: v0.1.0-17-g29f9b23-dirty
Build:   _build/magnet/github.com/gravitational/magnet/examples/golang
[+] Building 0.8s (1/1) FINISHED
 => build

❯ _build/example.container
Hello World
...
```
❯ go run mage.go test
Logs:    _build/logs/latest (_build/logs/20200723042430)
Version: v0.1.0-17-g29f9b23-dirty
Build:   _build/magnet/github.com/gravitational/magnet/examples/golang
[+] Building 0.7s (1/1) FINISHED
 => test

❯ cat _build/logs/latest/test
Name: test
